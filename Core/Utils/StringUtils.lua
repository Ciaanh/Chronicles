...
-- -------------------------
-- REMOVED: _G.Trim, _G.SplitTextToFitWidth, _G.cleanHTML, _G.containsHTML, _G.adjustTextLength
-- These functions are now accessed via: private.Core.Utils.StringUtils.*
